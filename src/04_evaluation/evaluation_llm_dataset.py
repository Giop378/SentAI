...
test_dataset_path = "../../data/sentiment_llm.csv"
...
#Verifica presenta di duplicati
duplicates = dataset_test[dataset_test.duplicated(subset=['text'], keep=False)]
if len(duplicates) > 0:
    print(f"ATTENZIONE: Sono presenti {len(duplicates)} duplicati nel dataset di test.")
    print(duplicates)
