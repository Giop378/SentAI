...
from joblib import dump  # Per salvare il modello
from src.preprocessor import CustomTweetPreprocessor  # Importa il preprocessor personalizzato
from sklearn.metrics import confusion_matrix

# Creazione della Pipeline
pipeline = Pipeline([
    ("preproc", CustomTweetPreprocessor()),
    ("tfidf", TfidfVectorizer(min_df=5, max_df=0.9)),  # Rappresentazione TF-IDF
    ("clf", LogisticRegression(random_state=42, max_iter=1000))  # Classificatore Logistic Regression
])
...
model_filename = "logistic_regression_tfidf_pipeline.joblib"
